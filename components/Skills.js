...
export default function Skills() {
  return (
    <div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-5 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[1em] sm2:ml-[1.8em] sm3:ml-[2.3em] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
