...
import jestIcon from '../public/img/jestIcon.jpg'
import lucidChartIcon from '../public/img/lucidchart_logo.webp'
import typeormIcon from '../public/img/typeorm.webp'
...
import nestjsIcon from '../public/img/nestjsIcon.jpeg'
import notionIcon from '../public/img/notion.jpeg'
import javaIcon from '../public/img/logo-java.webp'
import hibernateIcon from '../public/img/Hibernate_logo_a.webp'
import apacheIcon from '../public/img/Apache_Maven_logo.svg.webp'
import springbootIcon from '../public/img/springboot.webp'
import swaggerIcon from '../public/img/Swagger-logo.webp'
import jUnitIcon from '../public/img/JUnit_5_Banner.webp'
import vercelIcon from '../public/img/Vercel_logo_black.svg.webp'
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-20 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        ...
        <div className=' cursor-pointer border-[1px] ' title='Redux é uma biblioteca para armazenamento de estados de aplicações JavaScript, criado por Dan Abramov. Ele nasceu através de uma implementação do Flux, uma arquitetura criada pelo Facebook para contribuir com as aplicações de User Interface, utilizando o conceito de fluxo de dados unidirecional. Quando desenvolvemos aplicações utilizando Javascript, sempre temos que lidar com o gerenciamento de estado. O Redux veio para suprir essa necessidade de simplificar o controle dos estados de uma aplicação. Compartilhar estados entre vários componentes diferentes se torna uma coisa muito fácil quando o utilizamos.' ><Image src={reduxIcon} alt="reduxIcon" width='250px' height='200px' className='hover:scale-110  ' /></div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-5 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        <div className=' border-[1px] cursor-pointer  pt-4 ' title='O MySQL é um sistema de gerenciamento de banco de dados, que utiliza a linguagem SQL como interface. É atualmente um dos sistemas de gerenciamento de bancos de dados mais populares da Oracle Corporation, com mais de 10 milhões de instalações pelo mundo.' ><Image src={mysqlIcon} alt="mysqlIcon" width='200px' height='150px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer  pt-5 ' title='PostgreSQL é um sistema gerenciador de banco de dados objeto relacional, desenvolvido como projeto de código aberto.' ><Image src={postgreIcon} alt="postgreIcon" width='350px' height='240px' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer  pt-5 p-5 ml-auto mr-auto ' title='MongoDB é um software de banco de dados orientado a documentos livre, de código aberto e multiplataforma. Classificado como um programa de banco de dados NoSQL, o MongoDB usa documentos semelhantes a JSON com esquemas.' ><Image src={mongoIcon} alt="mongoIcon" width='120px' height='120px' className='hover:scale-105' /></div>
        <div className=' border-[1px] cursor-pointer  pt-7 ' title='TypeORM é um ORM que pode ser executado nas plataformas NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo e Electron e pode ser usado com TypeScript e JavaScript (ES5, ES6, ES7, ES8). Seu objetivo é sempre oferecer suporte aos recursos JavaScript mais recentes e fornecer recursos adicionais que o ajudem a desenvolver qualquer tipo de aplicativo que use bancos de dados - desde pequenos aplicativos com algumas tabelas até aplicativos corporativos de grande escala com vários bancos de dados.'><Image src={typeormIcon} alt="typeormIcon" width='320px' height='200px' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer  pt-7 ' title='Prisma é um Node.js e TypeScript ORM de próxima geração para PostgreSQL, MySQL, SQL Server, SQLite, MongoDB e CockroachDB. Ele fornece segurança de tipo, migrações automatizadas e um modelo de dados intuitivo.'><Image src={prismaIcon} alt="prismaIcon" width='300px' height='200px' className='hover:scale-110' /></div>
        ...
        <div className=' border-[1px] cursor-pointer  pt-2 ' title='O Mongoose é um ODM e fornece uma solução direta e baseada em esquema para modelar seus dados de aplicativos. Ele inclui conversão de tipo integrada, validação, criação de consulta, ganchos de lógica de negócios e muito mais, prontos para uso. ' ><Image src={mongooseIcon} alt="mongooseIcon" width='400px' height='320px' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer  pt-5 ' title='Firebase é uma plataforma desenvolvida pelo Google para a criação de aplicativos móveis e da web. Era originalmente uma empresa independente fundada em 2011. Em 2014, o Google adquiriu a plataforma e agora é sua oferta principal para o desenvolvimento de aplicativos.' ><Image src={firebaseIcon} alt="firebaseIcon" width='380px' height='300px' className='hover:scale-110 bg-cover ' /></div>
        <div className=' border-[1px] cursor-pointer  pt-10 ' title='O Hibernate é um framework para o mapeamento objeto-relacional escrito na linguagem Java, mas também é disponível em .Net com o nome NHibernate. Este framework facilita o mapeamento dos atributos entre uma base tradicional de dados relacionais e o modelo objeto de uma aplicação.' ><Image src={hibernateIcon} alt="hibernateIcon" width='600px' height='200px' className='hover:scale-110 ' /></div>

      </div>

      <h3 className=' border-[1px] text-center text-3xl font-bold bg-[#F2EFEA] '>BACK-END</h3>
      <div className="grid grid-cols-10 flex flex-wrap  gap-5 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        <div className=' border-[1px] cursor-pointer  pt-7 ' title='Node.js é um software de código aberto, multiplataforma, baseado no interpretador V8 do Google e que permite a execução de códigos JavaScript fora de um navegador web.' ><Image src={nodeIcon} alt="nodeIcon" width='300px' height='200px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer  pt-7 ' title='Express.js é um framework para Node.js que fornece recursos mínimos para construção de servidores web. Foi lançado como software livre e de código aberto sob a Licença MIT. É um dos mais populares frameworks para servidores em Node.js.' ><Image src={expressIcon} alt="expressIcon" width='300px' height='200px' className='hover:scale-110' /></div>
        <div className=' cursor-pointer mb-[-0.35em]' title='NestJS é um framework Node.js de código aberto destinado ao desenvolvimento de aplicativos do lado do servidor. Foi criado por Kamil Mysliwiec e lançado em 2017. Sob o capô, por padrão, o NestJS faz uso do framework Express.js, sendo também compatível com o Fastify. Sua arquitetura é fortemente inspirada no Angular.' ><Image src={nestjsIcon} alt="nestjsIcon" width='400px' height='400px' objectFit='fill' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer  pt-2 ' title='Java é uma linguagem de programação amplamente usada para codificar aplicações Web. Ela tem sido uma escolha popular entre os desenvolvedores há mais de duas décadas, com milhões de aplicações Java em uso hoje. Java é uma linguagem multiplataforma, orientada a objetos e centrada em rede que pode ser usada como uma plataforma em si. É uma linguagem de programação rápida, segura e confiável para codificar tudo, desde aplicações móveis e software empresarial até aplicações de big data e tecnologias do servidor.' ><Image src={javaIcon} alt="javaIcon" width='350px' height='300px' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer  pt-7 ' title='API RESTful é uma interface que fornece dados em um formato padronizado baseado em requisições HTTP. Ela fornece dados para essas aplicações, facilitando o cadastro e o acesso. API RESTful fica parada até que acontece uma requisição.' ><Image src={apiIcon} alt="apiIcon" width='300px' height='200px' className='hover:scale-110' /></div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-5 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        ...
        <div className=' border-[1px] cursor-pointer pt-10 ' title='Linux é um termo popularmente empregado para se referir a sistemas operativos ou sistemas operacionais que utilizam o Kernel Linux. O núcleo foi desenvolvido pelo programador finlandês Linus Torvalds, inspirado no sistema Minix. ' ><Image src={linuxIcon} alt="linuxIcon" width='350px' height='200px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-10 ' title='Gerencie qualquer tipo de projeto com mais eficiência sem precisar de um sistema ultrapassado.' ><Image src={notionIcon} alt="notionIcon" width='150px' height='100px' className='hover:scale-105 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-10 ' title='Diagramas de classes UML mapeiam a estrutura de um determinado sistema modelando suas classes, seus atributos, operações e relações entre objetos.' ><Image src={lucidChartIcon} alt="lucidChartIcon" width='350px' height='200px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-10 ' title='npm é um gerenciador de pacotes para o Node.JS npm, Inc. é uma subsidiária do GitHub, que fornece hospedagem para desenvolvimento de software e controle de versão com o uso do Git. npm é o gerenciador de pacotes padrão para o ambiente de tempo de execução JavaScript Node.js. ' ><Image src={npmIcon} alt="npmIcon" width='350px' height='250px' className='hover:scale-110 ' /></div>
        ...
        <div className=' border-[1px] bg-[#1f2229] cursor-pointer pt-3 ' title='Jest é um framework de teste unitário de código aberto em JavaScript criado pelo Facebook a partir do framework Jasmine.' ><Image src={jestIcon} alt="jestIcon" width='250px' height='250px' objectFit='fill' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer ' title='O Google Cloud Platform possibilita a criação de aplicativos e sites web mais otimizados, resultando no crescimento do seu negócio. Assim, a empresa pode desenvolver funções com finalidades únicas, capazes de responder aos eventos em nuvem.' ><Image src={googleIcon} alt="googleIcon" width='250px' height='250px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-8 ' title='A Amazon Web Services (ou AWS) existe de 2006 e oferece serviços de infraestrutura de TI para empresas por meio de serviços web – a chamada computação na nuvem, que nos dá a chance de trocar altos gastos com infraestrutura por preços que cabem no bolso. ' ><Image src={awsIcon} alt="awsIcon" width='300px' height='200px' className='hover:scale-110' /></div>
        <div className=' border-[1px] cursor-pointer pt-[4rem] ' title='O Frontend Cloud da Vercel oferece aos desenvolvedores estruturas, fluxos de trabalho e infraestrutura para construir uma Web mais rápida e personalizada.' ><Image src={vercelIcon} alt="vercelIcon" width='1200px' height='500px' className='hover:scale-105 bg-cover ' /></div>
        <div className=' border-[1px] cursor-pointer pt-7 ' title='Heroku é uma plataforma em nuvem como um serviço que suporta várias linguagens de programação. Uma das primeiras plataformas em nuvem, o Heroku está em desenvolvimento desde junho de 2007, quando suportava apenas a linguagem de programação Ruby, mas agora suporta Java, Node.js, Scala, Clojure, Python, PHP e Go.' ><Image src={herokuIcon} alt="herokuIcon" width='200px' height='120px' className='hover:scale-110 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-6 px-5 ' title='Docker é um conjunto de produtos de plataforma como serviço (PaaS) que usam virtualização de nível de sistema operacional para entregar software em pacotes chamados contêineres. Os contêineres são isolados uns dos outros e agrupam seus próprios softwares, bibliotecas e arquivos de configuração. Eles podem se comunicar uns com os outros por meio de canais bem definidos. Todos os contêineres são executados por um único kernel do sistema operacional e, portanto, usam menos recursos do que as máquinas virtuais.' ><Image src={dockerIcon} alt="dockerIcon" width='250px' height='250px' objectFit='fill' className='hover:scale-105 ' /></div>
        <div className=' border-[1px] cursor-pointer pt-6 ' title='Postman é uma plataforma de API para desenvolvedores projetarem, construírem, testarem e iterarem suas APIs. Em fevereiro de 2023, o Postman relata ter mais de 25 milhões de usuários registrados e 75.000 APIs abertas, o que, segundo ele, constitui o maior hub público de APIs do mundo. A empresa está sediada em San Francisco e mantém um escritório em Bangalore, onde foi fundada.' ><Image src={postmanIcon} alt="postmanIcon" width='150px' height='150px' className='hover:scale-105 bg-cover ' /></div>
        <div className=' border-[1px] cursor-pointer pt-10 ' title='O JUnit é um framework open-source, que se assemelha ao raio de testes software java, criado por Erich Gamma e Kent Beck, com suporte à criação de testes automatizados na linguagem de programação Java.' ><Image src={jUnitIcon} alt="jUnitIcon" width='500px' height='250px' className='hover:scale-105 bg-cover ' /></div>
        <div className=' border-[1px] cursor-pointer pt-[3rem] ' title='Apache Maven, ou Maven, é uma ferramenta de automação de compilação utilizada primariamente em projetos Java. Ela é similar à ferramenta Ant, mas é baseada em conceitos e trabalhos diferentes em um modo diferente.' ><Image src={apacheIcon} alt="apacheIcon" width='500px' height='200px' className='hover:scale-105 bg-cover ' /></div>
        <div className=' border-[1px] cursor-pointer pt-5 ' title='Swagger é um conjunto de ferramentas para desenvolvedores de API da SmartBear Software e uma especificação anterior na qual a especificação OpenAPI se baseia. O projeto Swagger API foi criado em 2011 por Tony Tam, cofundador técnico do site de dicionários Wordnik.' ><Image src={swaggerIcon} alt="swaggerIcon" width='350px' height='300px' className='hover:scale-105 bg-cover ' /></div>
