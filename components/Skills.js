  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-20 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        ...
        <div className=' cursor-pointer ' title='Jest é um framework de teste unitário de código aberto em JavaScript criado pelo Facebook a partir do framework Jasmine.' ><Image src={jestIcon} alt="jestIcon" width='210px' height='210px' className='hover:scale-110 bg-contain ' /></div>
      ...
      <div className="grid grid-cols-10 flex flex-wrap  gap-5 sm:w-[18em] sm2:w-[20em] sm3:w-[22em] md:w-[45em] lg:w-[50em] lg:ml-[6em] md:ml-[1.5em] sm:ml-[auto] sm:mr-[auto] mt-10 mb-20  sm:grid-cols-2 md:grid-cols-4 md:gap-10 lg:grid-cols-5 md:gap-20 lg:gap-20 xl:grid-row-10 xl:gap-10 xl:ml-[auto] xl:mr-[auto] xl:w-[60em] ">
        ...
        <div className=' border-[1px] cursor-pointer mt-[0.01em] pt-7 ' title='Prisma é um Node.js e TypeScript ORM de próxima geração para PostgreSQL, MySQL, SQL Server, SQLite, MongoDB e CockroachDB. Ele fornece segurança de tipo, migrações automatizadas e um modelo de dados intuitivo.'><Image src={prismaIcon} alt="prismaIcon" width='300px' height='200px' className='hover:scale-110' /></div>
