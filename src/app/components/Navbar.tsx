    ...
    return (
        <div className=' min-w-320 ' >
            ...
            <aside className="h-full w-[4rem] flex flex-col space-y-10 items-center justify-center bg-[#9BFF06] text-white fixed ">
                ...
                <Link legacyBehavior href={"#perfil"} scroll={true} >
                ...
                <Link legacyBehavior href={"#servicos"} scroll={true}  >
                ...
                <Link legacyBehavior href={"#habilidades"} scroll={true}>
                ...
                <Link legacyBehavior href={"#portfolio"} scroll={true}>
                ...
                <Link legacyBehavior href={"#contato"} scroll={true}>
