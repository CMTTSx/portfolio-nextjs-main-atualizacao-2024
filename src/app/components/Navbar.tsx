    ...
    return (
        <div className=' min-w-320 ' >
            ...
            <aside className="h-full w-[4rem] flex flex-col space-y-10 items-center justify-center bg-[#9BFF06] text-white fixed ">
                ...
                <Link href="/#perfil" legacyBehavior scroll={true} >
                    <a>
                ...
                <Link href="/#servicos" legacyBehavior scroll={true}>
                <a>
                ...
                <Link href="/#habilidades" legacyBehavior scroll={true}>
                <a>
                ...
                <Link href="/#portfolio" legacyBehavior scroll={true}>
                <a>
                ...
                <Link href="/#contato" legacyBehavior scroll={true}>
                <a>
