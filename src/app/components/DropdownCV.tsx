          ...
          <div className="py-1">
            <MenuItem>
              {({ focus }: any) => (
                ...
                >
                  <Link href="https://drive.google.com/drive/u/1/folders/1fx3Eeb4Uy2gd9EeApqFfn-whf9nxI8cN/view"><h4 className=' sm:pt-[0.5rem] flex flex-row ' ><Image src={euaFlagIcon} className='mr-2' alt='brf' />Curriculum</h4></Link>
                </Link>
              )}
            </MenuItem>
            <MenuItem>
