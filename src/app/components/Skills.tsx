...
function Skills() {
  return (
    <div>
      ...
      <h2 className=' lg:w-100% sm:pl-[3.5rem] sm2:pl-[4rem] lg:pl-[3rem] mt-[10rem] mb-[-15rem] text-center font-bold text-3xl mb-20 bg-[#00FF80] '>HABILIDADES</h2>
      ...
      <div className=' w-full mt-20 pt-[20rem] p-20 overflow-x-hidden ' >
        ...
        <div className="flex flex-wrap sm:ml-[1.8rem] sm360:ml-[3rem] sm2:ml-[3.5rem] sm3:ml-[4rem] sm4:ml-[5rem] sm:mr-[-4rem] lg:ml-[0rem] xl:ml-[3rem] lg:px-[6rem] mb-20 ">
          ...
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Com o CSS, versão 3. Pode-se criar estilos únicos para seus projetos web, alterando diversos aspectos de design no layout da página.' >
            <Image src={cssIcon} alt='cssIcon' className=' w-[55%] mx-auto pt-5 ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 hover:scale-110 cursor-pointer' title='JavaScript é uma linguagem de programação interpretada estruturada, de script em alto nível com tipagem dinâmica fraca e multiparadigma. Juntamente com HTML e CSS, o JavaScript é uma das três principais tecnologias da World Wide Web.' >
            <Image src={javascriptIcon} alt='javascriptIcon' className=' w-[100%] h-[100%] mx-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 hover:scale-110 cursor-pointer' title='TypeScript é uma linguagem de programação de código aberto desenvolvida pela Microsoft. É um superconjunto sintático estrito de JavaScript e adiciona tipagem estática opcional à linguagem. Tipos fornecem uma maneira de descrever a forma de um objeto, fornecendo melhor documentação e permitindo que o TypeScript valide se seu código está funcionando corretamente.'>
            <Image src={typescriptIcon} alt='typescriptIcon' className=' w-[100%] h-[100%] mx-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 pt-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Redux é uma biblioteca para armazenamento de estados de aplicações JavaScript, criado por Dan Abramov. Ele nasceu através de uma implementação do Flux, uma arquitetura criada pelo Facebook para contribuir com as aplicações de User Interface, utilizando o conceito de fluxo de dados unidirecional. Quando desenvolvemos aplicações utilizando Javascript, sempre temos que lidar com o gerenciamento de estado. O Redux veio para suprir essa necessidade de simplificar o controle dos estados de uma aplicação. Compartilhar estados entre vários componentes diferentes se torna uma coisa muito fácil quando o utilizamos.' >
            <Image src={reduxIcon} alt='reduxIcon' className=' w-[60%] mx-auto ' />
            <h5 className='text-center pt-4 font-bold ' >Redux</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 pt-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='O React é uma biblioteca JavaScript de código aberto com foco em criar interfaces de usuário em páginas web.' >
            <Image src={reactIcon} alt='reactIcon' className=' w-[63%] mx-auto ' />
            <h5 className='text-center pt-4 font-bold '>React</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 pt-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Next.js é uma estrutura da web de desenvolvimento front-end React de código aberto criada por Vercel que permite funcionalidades como renderização do lado do servidor e geração de sites estáticos para aplicativos da web baseados em React.' >
            <Image src={nextjsIcon} alt='nextjsIcon' className=' w-[80%] mx-auto pt-12 ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 pt-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='O Tailwind é uma coleção de componentes de interface do usuário bonitos e totalmente responsivos, projetados e desenvolvidos por nós, os criadores do Tailwind CSS. Ele tem centenas de exemplos prontos para usar e é garantido para ajudá-lo a encontrar o ponto de partida perfeito para o que você deseja construir.' >
            <Image src={tailwindIcon} alt='tailwindIcon' className=' w-[80%] mx-auto pt-12 ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 hover:scale-110 cursor-pointer' title='O estilo permite que você use a sintaxe CSS real dentro de seus componentes. Componentes com estilo é uma variante do “CSS-in-JS” – que resolve muitos dos problemas com o CSS tradicional. Um dos problemas mais importantes que eles resolvem são as colisões de nomes de seletores. Com CSS tradicional, você deve ter cuidado para não sobrescrever seletores CSS usados em outro lugar em um site porque todos os seletores CSS vivem no mesmo namespace global. Essa restrição infeliz pode levar a esquemas de nomenclatura de seletor elaborados (e muitas vezes confusos).' >
            <Image src={styledComponents} alt='styledComponents' className=' w-[100%] mx-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Bootstrap é um framework web com código-fonte aberto para desenvolvimento de componentes de interface e front-end para sites e aplicações web usando HTML, CSS e JavaScript, baseado em modelos de design para a tipografia, melhorando a experiência do usuário em um site amigável e responsivo.' >
            <Image src={bootstrap} alt='bootstrap' className=' w-[70%] mx-auto mt-4 ' />
            <h5 className='text-center pt-4 font-bold '>Bootstrap</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Biblioteca de componentes React para um desenvolvimento ágil e fácil. Construa seu próprio design.' >
            <Image src={materialUi} alt='materialUi' className=' w-[70%] mx-auto mt-4 ' />
            <h5 className='text-center pt-4 font-bold '>Material UI</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-2 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer'>
            <Image src={materialDesign} alt='materialDesign' className=' w-[60%] mx-auto ' title='Material Design (codinomeado Quantum Paper) é uma linguagem de design livre desenvolvida pela Google com o objetivo de unificar e padronizar as interfaces gráficas dos sistemas da empresa (conjunto de diretrizes ou guidelines), anunciado em 2014 como uma melhoria no "card" do assistente pessoa.' />
        ...
        <div className="flex flex-wrap sm:ml-[1.8rem] sm360:ml-[3rem] sm2:ml-[3.5rem] sm3:ml-[4rem] sm4:ml-[5rem] sm:mr-[-4rem] lg:ml-[0rem] xl:ml-[3rem] lg:px-[6rem] mb-20 ">
          ...
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='A usabilidade visa assegurar que produtos sejam fáceis de aprender a usar, eficazes e agradáveis, sempre na perspectiva do usuário. Não é apenas facilidade de uso, mas também trazer algo significativo, tendo um objetivo em comum com o usuário.' >
            <Image src={usabilidadeIcon} alt='usabilidadeIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Usabilidade</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='No contexto do software, o teste de acessibilidade é um processo para avaliar a usabilidade do sistema por pessoas que enfrentam algum tipo de restrição que podem ser permanentes, como uma deficiência, temporárias, como um dedo quebrado ou situacionais, como usar a aplicação enquanto segura uma criança.' >
            <Image src={acessibilidadeIcon} alt='acessibilidadeIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Acessibilidade</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Figma é um editor gráfico de vetor e prototipagem de projetos de design baseado principalmente no navegador web, com ferramentas offline adicionais para aplicações desktop para GNU/Linux, macOS e Windows.'>
            <Image src={figmaIcon} alt='figmaIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Figma</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='GitHub é uma plataforma de hospedagem de código-fonte e arquivos com controle de versão usando o Git. Ele permite que programadores, utilitários ou qualquer usuário cadastrado na plataforma contribuam em projetos privados e/ou Open Source de qualquer lugar do mundo.' >
            <Image src={githubIcon} alt='githubIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Github</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Adobe Photoshop é um software caracterizado como editor de imagens bidimensionais do tipo raster desenvolvido pela Adobe Systems. É considerado o líder no mercado dos editores de imagem profissionais, assim como o programa de facto para edição profissional de imagens digitais e trabalhos de pré-impressão.' >
            <Image src={photoshopIcon} alt='photoshopIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Photoshop</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-8 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Linux é um termo popularmente empregado para se referir a sistemas operativos ou sistemas operacionais que utilizam o Kernel Linux. O núcleo foi desenvolvido pelo programador finlandês Linus Torvalds, inspirado no sistema Minix. ' >
            <Image src={linuxIcon} alt='linuxIcon' className=' w-[100%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-5 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Gerencie qualquer tipo de projeto com mais eficiência sem precisar de um sistema ultrapassado.' >
            <Image src={notionIcon} alt='notionIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Notion</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-8 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Diagramas de classes UML mapeiam a estrutura de um determinado sistema modelando suas classes, seus atributos, operações e relações entre objetos.' >
            <Image src={lucidchartIcon} alt='lucidchartIcon' className=' w-[100%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 pt-12 border-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='npm é um gerenciador de pacotes para o Node.JS npm, Inc. é uma subsidiária do GitHub, que fornece hospedagem para desenvolvimento de software e controle de versão com o uso do Git. npm é o gerenciador de pacotes padrão para o ambiente de tempo de execução JavaScript Node.js.' >
            <Image src={npmIcon} alt='npmIcon' className=' w-[80%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 border-[#f0f0f0] bg-[#147bac] hover:scale-110 cursor-pointer' title='Yarn é um sistema de empacotamento de software desenvolvido em 2016 pelo Facebook para Node.js JavaScript runtime environment que fornece velocidade, consistência, estabilidade e segurança como uma alternativa ao npm (gerenciador de pacotes).' >
            <Image src={yarnIcon} alt='yarnIcon' className=' w-[70%] mx-auto ' />
            <h5 className='text-center text-white '>Yarn</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-3 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Jest é um framework de teste unitário de código aberto em JavaScript criado pelo Facebook a partir do framework Jasmine.' >
            <Image src={jestIcon} alt='jestIcon' className=' w-[50%] mx-auto py-auto ' />
            <h5 className='text-center pt-4' >Jest</h5>
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-[3.5rem] border-[#f0f0f0] hover:scale-110 cursor-pointer' title='O Google Cloud Platform possibilita a criação de aplicativos e sites web mais otimizados, resultando no crescimento do seu negócio. Assim, a empresa pode desenvolver funções com finalidades únicas, capazes de responder aos eventos em nuvem.' >
            <Image src={googleCloudIcon} alt='googleCloudIcon' className=' w-[80%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-12 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='A Amazon Web Services (ou AWS) existe de 2006 e oferece serviços de infraestrutura de TI para empresas por meio de serviços web – a chamada computação na nuvem, que nos dá a chance de trocar altos gastos com infraestrutura por preços que cabem no bolso. '>
            <Image src={awsIcon} alt='awsIcon' className=' w-[50%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-[3.5rem] border-[#f0f0f0] hover:scale-110 cursor-pointer' title='O Frontend Cloud da Vercel oferece aos desenvolvedores estruturas, fluxos de trabalho e infraestrutura para construir uma Web mais rápida e personalizada.' >
            <Image src={vercelIcon} alt='vercelIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-10 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Heroku é uma plataforma em nuvem como um serviço que suporta várias linguagens de programação. Uma das primeiras plataformas em nuvem, o Heroku está em desenvolvimento desde junho de 2007, quando suportava apenas a linguagem de programação Ruby, mas agora suporta Java, Node.js, Scala, Clojure, Python, PHP e Go.'>
            <Image src={herokuIcon} alt='herokuIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-5 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Docker é um conjunto de produtos de plataforma como serviço (PaaS) que usam virtualização de nível de sistema operacional para entregar software em pacotes chamados contêineres. Os contêineres são isolados uns dos outros e agrupam seus próprios softwares, bibliotecas e arquivos de configuração. Eles podem se comunicar uns com os outros por meio de canais bem definidos. Todos os contêineres são executados por um único kernel do sistema operacional e, portanto, usam menos recursos do que as máquinas virtuais.' >
            <Image src={dockerIcon} alt='dockerIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-10 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Postman é uma plataforma de API para desenvolvedores projetarem, construírem, testarem e iterarem suas APIs. Em fevereiro de 2023, o Postman relata ter mais de 25 milhões de usuários registrados e 75.000 APIs abertas, o que, segundo ele, constitui o maior hub público de APIs do mundo. A empresa está sediada em San Francisco e mantém um escritório em Bangalore, onde foi fundada.' >
            <Image src={postmanIcon} alt='postmanIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-10 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='O JUnit é um framework open-source, que se assemelha ao raio de testes software java, criado por Erich Gamma e Kent Beck, com suporte à criação de testes automatizados na linguagem de programação Java.' >
            <Image src={jUnitIcon} alt='jUnitIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-2 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Apache Maven, ou Maven, é uma ferramenta de automação de compilação utilizada primariamente em projetos Java. Ela é similar à ferramenta Ant, mas é baseada em conceitos e trabalhos diferentes em um modo diferente. ' >
            <Image src={mavenIcon} alt='mavenIcon' className=' w-[90%] mx-auto py-auto ' />
          </div>
          <div className=' w-[150px] h-[150px] mr-5 mb-20 border-2 pt-3 border-[#f0f0f0] hover:scale-110 cursor-pointer' title='Swagger é um conjunto de ferramentas para desenvolvedores de API da SmartBear Software e uma especificação anterior na qual a especificação OpenAPI se baseia. O projeto Swagger API foi criado em 2011 por Tony Tam, cofundador técnico do site de dicionários Wordnik.' >
            <Image src={swaggerIcon} alt='swaggerIcon' className=' w-[60%] mx-auto py-auto ' />
