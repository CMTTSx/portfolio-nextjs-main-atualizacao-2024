...
function Services() {
  return (
    <div className=' overflow-x-hidden ' >
      ...
      {/* CARDS SERVIÇOS */}
      <div className=" flex sm:flex-col lg:flex-row flex-wrap w-[95%] sm:mx-4 sm360:ml-[2rem] sm2:mx-9 sm3:mx-11 sm4:mx-[3.7rem] md:mx-[12rem] lg:ml-[4rem] xl:ml-[4.5rem] 2xl:ml-[4.5rem] lg:mr-[10rem] sm:mt-[20rem] lg:mt-[40rem] overflow-hidden ">
